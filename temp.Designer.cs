namespace VPS
{
    partial class temp
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.but_followswarm = new VPS.Controls.MyButton();
            this.label16 = new System.Windows.Forms.Label();
            this.but_lockup = new VPS.Controls.MyButton();
            this.but_td = new VPS.Controls.MyButton();
            this.but_gpsinj = new VPS.Controls.MyButton();
            this.but_dem = new VPS.Controls.MyButton();
            this.BUT_magfit2 = new VPS.Controls.MyButton();
            this.but_GDAL = new VPS.Controls.MyButton();
            this.myButton2 = new VPS.Controls.MyButton();
            this.but_sortlogs = new VPS.Controls.MyButton();
            this.but_optflowcalib = new VPS.Controls.MyButton();
            this.but_logdlscp = new VPS.Controls.MyButton();
            this.but_signkey = new VPS.Controls.MyButton();
            this.but_acbarohight = new VPS.Controls.MyButton();
            this.myButton1 = new VPS.Controls.MyButton();
            this.but_driverclean = new VPS.Controls.MyButton();
            this.but_agemapdata = new VPS.Controls.MyButton();
            this.but_packetbytes = new VPS.Controls.MyButton();
            this.myButton_vlc = new VPS.Controls.MyButton();
            this.label22 = new System.Windows.Forms.Label();
            this.but_trimble = new VPS.Controls.MyButton();
            this.but_hwids = new VPS.Controls.MyButton();
            this.BUT_QNH = new VPS.Controls.MyButton();
            this.but_reboot = new VPS.Controls.MyButton();
            this.but_3dmap = new VPS.Controls.MyButton();
            this.but_messageinterval = new VPS.Controls.MyButton();
            this.but_blupdate = new VPS.Controls.MyButton();
            this.BUT_fft = new VPS.Controls.MyButton();
            this.but_disablearmswitch = new VPS.Controls.MyButton();
            this.but_paramrestore = new VPS.Controls.MyButton();
            this.but_mavinspector = new VPS.Controls.MyButton();
            this.but_sitl_comb = new VPS.Controls.MyButton();
            this.but_anonlog = new VPS.Controls.MyButton();
            this.but_dashware = new VPS.Controls.MyButton();
            ...
            this.butlogindex = new VPS.Controls.MyButton();
            this.but_armandtakeoff = new VPS.Controls.MyButton();
            this.but_maplogs = new VPS.Controls.MyButton();
            this.label17 = new System.Windows.Forms.Label();
            this.but_gimbaltest = new VPS.Controls.MyButton();
            this.but_structtest = new VPS.Controls.MyButton();
            ...
            this.BUT_clearcustommaps = new VPS.Controls.MyButton();
            this.but_getfw = new VPS.Controls.MyButton();
            this.BUT_geinjection = new VPS.Controls.MyButton();
            this.label8 = new System.Windows.Forms.Label();
            this.label7 = new System.Windows.Forms.Label();
            this.BUT_sorttlogs = new VPS.Controls.MyButton();
            ...
            this.BUT_outputMD = new VPS.Controls.MyButton();
            this.BUT_outputnmea = new VPS.Controls.MyButton();
            this.BUT_georefimage = new VPS.Controls.MyButton();
            this.button3 = new VPS.Controls.MyButton();
            this.BUT_lang_edit = new VPS.Controls.MyButton();
            this.BUT_follow_me = new VPS.Controls.MyButton();
            this.BUT_paramgen = new VPS.Controls.MyButton();
            this.but_osdvideo = new VPS.Controls.MyButton();
            this.BUT_movingbase = new VPS.Controls.MyButton();
            this.BUT_shptopoly = new VPS.Controls.MyButton();
            this.BUT_swarm = new VPS.Controls.MyButton();
            this.BUT_followleader = new VPS.Controls.MyButton();
            this.label1 = new System.Windows.Forms.Label();
            this.but_mavserialport = new VPS.Controls.MyButton();
            this.but_hexmavlink = new VPS.Controls.MyButton();
            ...
            this.but_remotedflogger = new VPS.Controls.MyButton();
            this.controlSensorsStatus1 = new VPS.Controls.ControlSensorsStatus();
